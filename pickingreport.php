...
company_users.lastname FROM collecting AS c INNER JOIN company_users ON c.buyer_telegram_id = company_users.telegram_id ORDER BY collecting_id DESC";
        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="pickingreport.php" tabindex="-1" aria-disabled="true">Picking Report</a>
                    </li>
                    <li class="nav-item">
    ...
    $(document).ready(function() {
        ...
        $('#filter').click(function() {
            ...
            if ((from_date != '' && to_date != '') && filter_farm == '') {
                ...
                $.ajax({
                    url: "pickingfilterByDateFarm.php",
                    method: "POST",
                    data: {
                        from_date: from_date,
                        to_date: to_date,
