...
company_users.lastname FROM collecting AS c INNER JOIN company_users ON c.buyer_telegram_id = company_users.telegram_id WHERE collecting_date BETWEEN '" . $_POST["from_date"] . "' AND '" . $_POST["to_date"] . "' AND farm_name = '" . $_POST["filter_farm"] . "'   
      ";
