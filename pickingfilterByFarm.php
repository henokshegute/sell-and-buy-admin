...
company_users.lastname FROM collecting AS c INNER JOIN company_users ON c.buyer_telegram_id = company_users.telegram_id WHERE farm_name = '" . $_POST["filter_farm"] . "'   
      ";
